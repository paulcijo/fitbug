...
Future<FFFirestorePage<WorkoutsRecord>> queryWorkoutsRecordPage({
  ...
  int pageSize,
    ...
    queryCollectionPage(WorkoutsRecord.collection, WorkoutsRecord.serializer,
        queryBuilder: queryBuilder,
        nextPageMarker: nextPageMarker,
        pageSize: pageSize);
...
Stream<List<LogsRecord>> queryLogsRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(LogsRecord.collection, LogsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<LogsRecord>> queryLogsRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(LogsRecord.collection, LogsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<FFFirestorePage<LogsRecord>> queryLogsRecordPage({
  ...
  int pageSize,
    ...
    queryCollectionPage(LogsRecord.collection, LogsRecord.serializer,
        queryBuilder: queryBuilder,
        nextPageMarker: nextPageMarker,
        pageSize: pageSize);
